...
class ROLLOUT(object):
    def __init__(self, lstm, update_rate):
        ...
        with tf.device("/cpu:0"):
            self.processed_x = tf.transpose(tf.concat([self.x[:, :, :2], tf.nn.embedding_lookup(self.g_embeddings, tf.cast(self.x[:, :, 2], tf.int32))], axis=2), perm=[1, 0, 2])  # seq_length x batch_size x (emb_dim + 2)
        ...
        ta_x = ta_x.unstack(tf.transpose(self.x, perm=[1, 0, 2]))
        #####################################################################################################
        ...
        self.gen_x = tf.transpose(self.gen_x, perm=[1, 0, 2])  # batch_size x seq_length x 3
